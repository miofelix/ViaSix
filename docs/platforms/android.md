...
- VPN MTU：设置页可在与 macOS 一致的 1280–9000 安全范围内调整，默认 1500；参数随 Activity、磁贴与 Sticky/Always-on 系统恢复统一传递，并进入 `Tun2SocksEngine`，TCP 下行按 IPv4/IPv6 与 TCP 固定头开销切分，合成报文不会超过接口 MTU
