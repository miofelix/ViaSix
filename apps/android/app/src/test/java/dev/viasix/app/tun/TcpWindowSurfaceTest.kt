...
class TcpWindowSurfaceTest {
    ...
    fun advertisedWindowLimitsRemoteSocketReads() {
        ...
        assertTrue(engine.contains("segmentSequence = tcp.seq"))
        ...
        assertTrue(window.contains("windowUpdateSequence"))
        assertTrue(window.contains("windowUpdateAcknowledgement"))
        assertTrue(window.contains("acceptsWindowUpdate(segmentSequence, acknowledgement)"))
