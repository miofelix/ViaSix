...
class TileSurfaceTest {
    ...
    fun tileServiceAndManifestPresent() {
        ...
        assertTrue(serviceText.contains("POST_NOTIFICATIONS_PERMISSION"))
        assertTrue(serviceText.contains("NotificationPermissionFlow.beforeStart"))
        assertTrue(serviceText.contains("openAppForStart()"))
